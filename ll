...
local Config = {
    ...
    ServiceId       = 27240, -- Your PlatoBoost Service ID
    PlatoSecret     = "64292601-529f-4a1a-ad79-f2e95ccf339a", -- Your PlatoBoost Secret Key
    ...
    MainGuiName     = "Main", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "Key system", -- The main title shown at the top of the GUI
    HubDescription  = "i need money bro" -- The text shown below the title
}
